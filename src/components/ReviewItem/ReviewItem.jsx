...
const ReviewItem = ({data,handleRemoveFromCart}) => {
    // console.log(data);
    const {id,img,name,price,quantity,ratings,shipping} = data;
    return (
        <div className='p-4 border flex items-center justify-between border-amber-300 mt-4 rounded-md'>
            ...
            <button onClick={()=>handleRemoveFromCart(id)} className='bg-amber-400 h-10 w-10 rounded-full flex justify-center items-center'>
